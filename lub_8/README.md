...
1 Четко разделить ответственность между компонентами приложения

2 Обеспечить модульность и поддерживаемость кода

3 Упростить тестирование отдельных компонентов системы

4 Модели содержат бизнес-логику, представления отвечают за отображение данных, контроллер осуществляет координацию между ними.
